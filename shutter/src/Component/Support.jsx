    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-blue-50">
      ...
      >
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-4">
          <h1 className="text-4xl cursor-pointer hover:underline mt-10 md:text-5xl font-bold text-white mb-6 text-center relative">
            <span className="text-orange-300  ">Customer</span>{" "}
            <span className="group">
              <span className=" ">Support</span> Center
              <button
                onClick={() => navigate('/enquire')}
                className="inline-block ml-2 text-4xl text-white hover:bg-opacity-70 transition-opacity duration-300"
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div
          ref={section1Ref}
          className={`flex flex-col md:flex-row items-center mb-24 gap-12 transition-all duration-1000 ease-out ${section1Visible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'
            }`}
        >
        ...
        <div
          ref={section2Ref}
          className={`flex flex-col md:flex-row-reverse items-center mb-24 gap-12 transition-all duration-1000 ease-out ${section2Visible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'
            }`}
        >
          <div className="md:w-1/2">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
        ...
        <div
          ref={section3Ref}
          className={`flex flex-col md:flex-row items-center gap-12 transition-all duration-1000 ease-out ${section3Visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            }`}
        >
          <div className="md:w-1/2">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <h2 className="text-2xl font-bold text-gray-800 mb-4">
                ...
                <button
                  ...
                  className="inline-block ml-2 text-3xl text-orange-500 hover:text-orange-600 transition-colors duration-300"
