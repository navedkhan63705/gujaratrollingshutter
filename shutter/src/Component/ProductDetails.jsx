        ...
        <nav className="flex" aria-label="Breadcrumb">
          <ol className="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
              <div className="flex items-center">
                <span className="mx-2 text-gray-400">/</span>
                <a href={`/product/${speciality}`} className="text-gray-700 hover:text-orange-500">
                  {speciality}
                </a>
              </div>
            </li>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mt-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {productData
              .filter(item => item.speciality === speciality && item.name !== productName)
              .slice(0, 4)
              .map((item, index) => (
                <div
                  key={index}
                  onClick={() => navigate(`/product/${item.speciality}/details/${item.name}`)}
